#!/usr/bin/env python3
"""Run the live eviction-only NIAH arm on Modal H100."""
# ruff: noqa: E402
...
from vorn_mat import ModalLiveEvictionRunRequest, build_vorn_entrypoint, run_modal_live_eviction_niah
...
def main(
    ...
    output: str = str(ROOT / ".benchmarks" / "modal-niah-live-eviction-h100-report.json"),
) -> None:
    ...
    request = ModalLiveEvictionRunRequest(
        ...
        output_path=(
            ...
            f"{cache_budget_tokens}-{eviction_trigger}-h100.jsonl"
        ),
