...
\textbf{Build pipeline.} The paper LaTeX source is kept privately as of
2026-05-27. The Markdown draft + pandoc workflow was retired after
surgical \texttt{.tex} edits exceeded round-trippable scope. The paper
builds via xelatex + bibtex with natbib and geometry preambles. Build
pipeline documentation is kept alongside the source.
