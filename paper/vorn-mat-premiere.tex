...
\item
  ...
  dominates token-attention-weight at constrained budget (paired p $\le$
...
multi-budget 2×2 coverage after the 2026-05-20 budget-fill spans b $\in$
...
0.66-0.76 across b=256/512/1024 with per-family spread $\le$ 0.06). The
