...
% v1.2 title candidate (adoption pending; if adopted, update \hypersetup pdftitle to match):
% "Vorn: Residual Facing and Family-Conditional KV-Cache Eviction"
\title{Vorn: Residual Direction, Familial Eviction, and the
Granularity Rescue Spectrum}
\author{L. Penney}
\date{August 2026 \textperiodcentered{} v1.2}
...
--- not a claim about the model's intention or viewpoint; §3.1 gives
